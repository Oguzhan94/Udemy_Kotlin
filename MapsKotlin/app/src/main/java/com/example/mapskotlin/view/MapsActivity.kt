...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapLongClickListener{
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //41.13818279922983, 29.030314086923372
        //val forest = LatLng(41.13818279922983, 29.030314086923372)
        //mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(forest, 13f))
        //mMap.addMarker(MarkerOptions().position(forest).title("Ataturk Kent Ormani"))
    }
            ...
            registerForActivityResult(ActivityResultContracts.RequestPermission()) { result ->
                if (result) {
                    if (ContextCompat.checkSelfPermission(
                        ...
                        Toast.makeText(this, "Permission needen", Toast.LENGTH_LONG).show()
                    }
